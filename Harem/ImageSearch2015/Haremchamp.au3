...
;Image data
$champions = "E:\Github\AutoIT-game-Automaton\Harem\images\champions.png"
$skip = "E:\Github\AutoIT-game-Automaton\Harem\images\skip.png"
...
While True
	...
	Do
		$inFlag = _ImageSearch($champions, 1, $xLocation, $yLocation, 75, 0)
	...
	Do
		$inFlag = _ImageSearch($skip, 1, $xLocation, $yLocation, 75, 0)
		MouseMove(100, 100, 10)
		MouseMove(100, 150, 10)
	Until $inFlag = True
	Sleep(500)
